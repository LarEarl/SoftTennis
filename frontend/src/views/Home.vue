          ...
          >
            <div class="flex flex-col md:flex-row md:items-center gap-4">
              <img
                v-if="news.image"
                :src="news.image"
                class="w-full md:w-44 h-40 object-cover rounded mb-3 md:mb-0 md:mr-4"
              />
              <div>
        ...
        <div class="bg-white rounded-xl shadow p-6">
          ...
          <div v-if="limitedMatches.length" class="space-y-3">
            ...
            >
              ...
              <router-link
                :to="`/matches/${match.id}`"
                class="flex justify-between items-center mt-1 hover:underline"
              >
